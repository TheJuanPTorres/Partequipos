...
| **Datos, medido en 3.89.0 (2026-09-23), SIN CORREGIR.** Recortar en el panel actualiza el ancho, el alto y el peso del REGISTRO, pero el fichero que se sube a Vercel Blob es el ORIGINAL (1200×800 en vez de 600×400). Igual con y sin nuestro gancho                                                      | El registro miente sobre el fichero: `next/image` pintaría la imagen con la proporción equivocada                                                    | **Ninguna todavía.** No recortar en el panel; recortar antes de subir (CLAUDE.md §10.32)                                                                                                                                                                                                                   |
