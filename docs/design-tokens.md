...
| **Datos, observado en 3.89.0 (2026-09-23), CAUSA SIN DEMOSTRAR.** Tras recortar en el panel, el registro dice 600×400 y la URL del Blob siguió sirviendo el original durante al menos 54 s. Puede ser el fichero mal escrito o la caché del CDN (Vercel: hasta 60 s al sobrescribir; y el plugin sube con `max-age` de un año en el mismo nombre). Igual con y sin nuestro gancho | El registro miente sobre el fichero: `next/image` pintaría la imagen con la proporción equivocada                                                    | **Ninguna todavía.** No recortar en el panel; recortar antes de subir (CLAUDE.md §10.32)                                                                                                                                                                                                                   |
