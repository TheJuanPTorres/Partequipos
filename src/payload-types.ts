...
export interface Pagina {
  ...
  hero?: {
    diapositivas?:
      | {
          /**
           * Ej. «Potencia Hitachi». Se pinta en mayúsculas por diseño.
           */
          titulo: string;
          /**
           * El texto del recuadro de vidrio. No se muestra en móvil.
           */
          parrafo?: string | null;
...
export interface Sede {
  ...
  longitud: number;
  /**
   * Cada línea con su dirección. Ej. Maquinaria · Diagonal 16 # 96 G – 85.
   */
  lineas?:
    | {
        linea: string;
        /**
         * Solo si no es el de la sede. Ej. «Guarne» en Antioquia.
         */
